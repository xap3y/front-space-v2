...
export function EmailPage({ maxWidth, isPublic = false, initialTempMail = null }: Props) {
    ...
    const { tempMail: hookTempMail, createTempMail, refetchTempMailInfo, loadFromLocalStorage, setExistingTempMail } = useTempMail();
    const [wsForceRefreshId, setWsForceRefreshId] = useState(0);

    // Use initialTempMail if provided (public mode), otherwise use hook state (private mode)
    const tempMail = initialTempMail || hookTempMail;
                            ...
                            <div className="space-y-2 w-full">
                                <div className="flex items-center gap-2.5 group">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded text-xs font-medium text-gray-400 hover:text-gray-200 hover:bg-white/5 border border-white/10 hover:border-white/20 transition-all opacity-0 group-hover:opacity-100"

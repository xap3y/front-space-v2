...
export default function DashboardLauncherClient() {
    ...
    if (loadingUser || !user) {
        return (
            <div className="min-h-screen px-4 py-8 animate-pulse bg-primaryDotted bg-primaryDottedSize">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12 space-y-3">
                        <div className="h-10 w-48 bg-zinc-700 rounded mx-auto" />
                        <div className="h-5 w-64 bg-zinc-800 rounded mx-auto" />
                    </div>

...
export default function ImageEditorClient() {
    ...
    useEffect(() => {
        const handleKey = (event: KeyboardEvent) => {
            if (event.key === "Escape") {
                if (uploadsOpen) setUploadsOpen(false);
    ...
    }, [selectedId, sourceOpen, uploadsOpen, undo]);
